...
return [
    ...
    'Float::isNotZero'                       => 'The :attribute must not be zero.',
    'Float::isPositive'                      => 'The :attribute must be a positive value.',
    'Float::isPositiveOrZero'                => 'The :attribute must be a positive value or zero.',
    'Float::isNegative'                      => 'The :attribute must be a negative value.',
    'Float::isNegativeOrZero'                => 'The :attribute must be a negative value or zero',
    'Float::isBetween'                       => 'The :attribute must be between :min and :max.',
    'Float::isOdd'                           => 'The :attribute must be divisible by 3.',
    'Float::isEven'                          => 'The :attribute must be divisible by 2.',
    'Float::isMultiple'                      => 'The :attribute must be multiple of :size.',
    //Integer
    'Integer::__construct'                   => 'The :attribute must be an integer.',
    'Integer::isNotZero'                     => 'The :attribute must not be zero.',
    'Integer::isPositive'                    => 'The :attribute must be a positive value.',
    'Integer::isPositiveOrZero'              => 'The :attribute must be a positive value or zero.',
    'Integer::isNegative'                    => 'The :attribute must be a negative value.',
    'Integer::isNegativeOrZero'              => 'The :attribute must be a negative value or zero',
    'Integer::isBetween'                     => 'The :attribute must be between :min and :max.',
    'Integer::isOdd'                         => 'The :attribute must be divisible by 3.',
    'Integer::isEven'                        => 'The :attribute must be divisible by 2',
